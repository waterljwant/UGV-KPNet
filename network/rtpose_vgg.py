...
def get_model(trunk='vgg19', numkeypoints=18, numlims=19):
    ...
    blocks['block1_1'] = [{'conv5_1_CPM_L1': [128, 128, 3, 1, 1, 1]},
                          ...
                          {'conv5_5_CPM_L1': [512, numlims*2, 1, 1, 0, 1]}]
    ...
    blocks['block1_2'] = [{'conv5_1_CPM_L2': [128, 128, 3, 1, 1, 1]},
                          ...
                          {'conv5_5_CPM_L2': [512, numkeypoints+1, 1, 1, 0, 1]}]

    # Stages 2 - 6
    for i in range(2, 7):
        blocks['block%d_1' % i] = [
            {'Mconv1_stage%d_L1' % i: [128+numlims*2+numkeypoints+1, 128, 7, 1, 3, 1]},
            ...
            {'Mconv7_stage%d_L1' % i: [128, numlims*2, 1, 1, 0, 1]}
        ]

        blocks['block%d_2' % i] = [
            {'Mconv1_stage%d_L2' % i: [128+numlims*2+numkeypoints+1, 128, 7, 1, 3, 1]},
            ...
            {'Mconv3_stage%d_L2' % i: [128, 128, 7, 1, 3*2, 2]},  # dilation
            {'Mconv4_stage%d_L2' % i: [128, 128, 7, 1, 3*3, 3]},  # dilation
            {'Mconv5_stage%d_L2' % i: [128, 128, 7, 1, 3*5, 5]},  # dilation

            {'Mconv6_stage%d_L2' % i: [128, 128, 1, 1, 0, 1]},
            {'Mconv7_stage%d_L2' % i: [128, numkeypoints+1, 1, 1, 0, 1]}
        ]
    ...
    class rtpose_model(nn.Module):
        def __init__(self, model_dict, numkeypoints=18, numlims=19):
    ...
    model = rtpose_model(models, numkeypoints=numkeypoints, numlims=numlims)
    return model
